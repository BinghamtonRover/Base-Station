...
const imuPort = "/dev/base-station-imu";
...
class ImuReader extends Service {
  ...
  late final serial = SerialDevice(
    portName: imuPort,
    readInterval: const Duration(milliseconds: 10),
    logger: logger,
  );

  /// The last measured reading from the IMU
  RoverPosition lastOrientation = RoverPosition();
